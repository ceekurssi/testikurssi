 ...
 * Function CashRegister_free should free all allocated memory and return 1 if successful.*/
...
int main(void) {
    ...
    printf("%s: balance is %.2f\n", getName_FrankCard(cardKalle), getBalance_FrankCard(cardKalle)); /*Kalle's card: balance is 2.00*/
    ...
    printf("%s: balance is %.2f\n", getName_FrankCard(cardKalle), getBalance_FrankCard(cardKalle)); /*Kalle's card: balance is 147.40*/
