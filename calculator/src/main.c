 ...
 * Write function calculate() that asks three values from the user, floating point number, character and floating point number.
 * Character should be one of the following operators: '+', '-', '*' or '/'. If the user doesn't give a valid number-operator-number input, the function should print "error".
